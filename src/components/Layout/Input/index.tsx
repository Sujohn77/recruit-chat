...
import React, { ChangeEvent, FC, useState, Dispatch, SetStateAction, forwardRef, RefObject } from 'react';
            ...
            <S.Wrapper>
                ...
                {error !== null && (
                    <S.ErrorText>
                        {error}
                        {isErrorIcon && (
                            <Image src={IMAGES.WARN} style={{ marginLeft: '5px', width: '12px', height: '12px' }} />
                        )}
                    </S.ErrorText>
                )}
            </S.Wrapper>
