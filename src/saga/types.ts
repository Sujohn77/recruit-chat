...
export interface IActionWithRepeat {
    isRepeat?: boolean;
  }
  export interface SendMessageAction extends IActionWithRepeat {
    type: chatsActionTypes.SEND_MESSAGE;
    message: IApiMessage;
    sender: IUserSelf;
    chatId: number;
  }
  export interface UpdateChatRoomMessagesAction extends IChatRoomID {
    type: chatsActionTypes.UPDATE_CHAT_ROOM_MESSAGES;
